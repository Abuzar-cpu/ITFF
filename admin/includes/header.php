<?php
		...
		if (!isset($_SESSION["sess_admin_login"])){header("location:"."index.php");}
			...
			<li><a href="admins.php"> <i class="glyphicon glyphicon-eur"></i>Admins <span class="pull-right"><?=counting("admins", "id")?></span></a></li>
<li><a href="messages.php"> <i class="glyphicon glyphicon-text-color"></i>Messages <span class="pull-right"><?=counting("messages", "id")?></span></a></li>
<li><a href="skills.php"> <i class="glyphicon glyphicon-level-up"></i>Skills <span class="pull-right"><?=counting("skills", "id")?></span></a></li>
