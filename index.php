            ...
            <div class="container">
                <div class="row ms-auto me-auto">
                    <div class="col-sm-6 text-center">
                        <h2>SKILLS WE GOT</h2><!-- /.progress-group -->
                        <?php
                            include 'db.php';
                            if (!con) {
                                echo "Sorry";
                                ...
                                for ($i=0; $i < mysqli_num_rows($run); $i++) { 
                                    ...
                                    printf("<p>%s</p>", $result[$i]['name']);
                                    echo "<div class='progress'>";
                                    printf ("<div class='progress-bar' role='progressbar' data-transitiongoal='%d'></div></div></div>", $result[$i]['level']);
                                }
                            }
                        ?>
                    </div>
